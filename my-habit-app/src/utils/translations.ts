...
export const translations = {
  ko: {
    ...
    'day.short.monday': '월',
    'day.short.tuesday': '화',
    'day.short.wednesday': '수',
    'day.short.thursday': '목',
    'day.short.friday': '금',
    'day.short.saturday': '토',
    'day.short.sunday': '일',
    // 차트/통계
    'chart.weekly.prefix': '주간',
    'chart.total.completion': '전체 달성률',
    'chart.routine.completion': '루틴 달성률',
    'chart.habit.completion': '습관 달성률',
    'chart.total.satisfaction': '전체 만족도',
    'chart.routine.satisfaction': '루틴 만족도',
    'chart.habit.satisfaction': '습관 만족도',
  },
  en: {
    // Header & Navigation
    ...
    'day.short.sunday': 'S',
    // Chart/Statistics
    'chart.weekly.prefix': 'Weekly',
    'chart.total.completion': 'Total Completion',
    'chart.routine.completion': 'Routine Completion',
    'chart.habit.completion': 'Habit Completion',
    'chart.total.satisfaction': 'Total Satisfaction',
    'chart.routine.satisfaction': 'Routine Satisfaction',
    'chart.habit.satisfaction': 'Habit Satisfaction',
  }
};
